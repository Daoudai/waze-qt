...
void device_event_info_init( device_event_info_ptr me)
{ memset( me, 0, sizeof(device_event_info));}

void device_event_info_free( device_event_info_ptr me)
{ device_event_info_init( me);}
