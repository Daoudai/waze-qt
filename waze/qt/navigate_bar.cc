...
static const char NAVIGATE_DIR_IMG[][40] = {
   "big_direction_left",
   "big_direction_right",
   "big_direction_keep_left",
   "big_direction_keep_right",
   "big_direction_forward",
   "big_directions_roundabout_e",
   "big_directions_roundabout_e",
   "big_directions_roundabout_l",
   "big_directions_roundabout_l",
   "big_directions_roundabout_s",
   "big_directions_roundabout_s",
   "big_directions_roundabout_r",
   "big_directions_roundabout_r",
   "big_directions_roundabout_u",
   "big_directions_roundabout_u",
   "big_direction_end",
   "big_direction_exit_left",
   "big_direction_exit_right",
    ""
};
...
static const char NAVIGATE_UK_DIR_IMG[][40] = {
   ...
   "big_direction_keep_right",
   "big_direction_forward",
   "big_directions_roundabout_UK_e",
   "big_directions_roundabout_UK_e",
   "big_directions_roundabout_UK_l",
   "big_directions_roundabout_UK_l",
   "big_directions_roundabout_UK_s",
   "big_directions_roundabout_UK_s",
   "big_directions_roundabout_UK_r",
   "big_directions_roundabout_UK_r",
   "big_directions_roundabout_UK_u",
   "big_directions_roundabout_UK_u",
   "big_direction_end",
   "big_direction_exit_left",
   "big_direction_exit_right",
