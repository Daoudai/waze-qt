...
// This is T E R R I B L E  !!! We have to redesign this!! AGA
...
#elif defined(QTMOBILITY)
   RoadMapGpsProtocol = ROADMAP_GPS_QTM;
   RoadMapGpsLink.subsystem = ROADMAP_IO_NULL;
#endif
#endif // __SYMBIAN32__
#endif // IPHONE
   ...
   switch (RoadMapGpsProtocol) {
      ...
      case ROADMAP_GPS_SYMBIAN:
         ...
         break;
#elif defined (QTMOBILITY)
      case ROADMAP_GPS_QTM:

         roadmap_gpsqtm_subscribe_to_navigation (roadmap_gps_navigation);
...
void roadmap_gps_input (RoadMapIO *io) {
   ...
   switch (RoadMapGpsProtocol) {
      ...
      case ROADMAP_GPS_QTM:
        ...
        decode.decoder = roadmap_gpsqtm_decode;
        decode.decoder_context = NULL;
        decode.is_binary = 1;
        break;
#else /*J2ME */
...
#else
   res = roadmap_gpsqtm_input(&decode);
#endif
